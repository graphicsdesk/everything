...
|:-------:|------|-------------|--------------|
| [:link:](https://www.columbiaspectator.com/news/2020/04/18/segregation-exposes-black-residents-to-health-risks-hospitals-are-disincentivized-from-treating-them/) | [`low-income-hospitals`](https://github.com/graphicsdesk/low-income-hospitals) | Measuring the accessibility of emergency hospitals to low-income neighborhoods. | [Hong](https://github.com/HongSenDu), [Mike](https://github.com/haohaom1) and [Raeedah](https://github.com/raeedahw) |
...
| Article | Repo | Description | Contact |
|:-------:|------|-------------| ------- |
| [:link:](https://www.columbiaspectator.com/news/2020/04/17/methodology-how-spectator-mapped-the-disparity-in-healthcare-access-between-the-segregated-neighborhoods-of-nyc/) | [`hospital-data`](https://github.com/graphicsdesk/hospital-data) | Open/closed emergency hospitals across New York City by neighborhood and income level. | [Mike](https://github.com/haohaom1) and [Raeedah](https://github.com/raeedahw) |
